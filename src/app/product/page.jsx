...
export default function ProductListingPage() {
  ...
  const filteredProducts = products.filter((product) => {
    ...
    const categoryMatch = activeCategory === "All" || product.priority === activeCategory;
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <p className="text-stone-400 font-bold uppercase tracking-widest">Loading Catalog...</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
            {filteredProducts.length > 0 ? (
              ...
              <div className="col-span-full text-center py-20 bg-white rounded-[3rem] border-2 border-dashed border-orange-100">
                <p className="text-stone-400 text-xl font-medium">No products found matching your selection.</p>
                <Button 
                  variant="link" 
